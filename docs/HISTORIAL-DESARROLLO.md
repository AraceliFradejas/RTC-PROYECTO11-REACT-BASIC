# Mi historial de desarrollo · Expediente X

> He recuperado este registro del commit `38bff81`. Conservo los estados y pendientes de cada fase como antecedentes; el estado actual está en [mi memoria](../MEMORIA.md). Las capturas históricas se mantienen en este repositorio.
...
![Mi archivo de Akte X en móvil, con el aviso de catálogo no disponible](screenshots/inicio/archivo-movil-de.png)
...
![Mi detalle móvil de Piloto](screenshots/detalle-piloto.png)
...
He organizado la página en seis recuerdos, con encabezados y párrafos que puedo leer también en inglés y alemán. Conservo la versión castellana en [Mi historia](MI-HISTORIA.md). Mantengo los créditos de TMDB y JustWatch al final de la página.
